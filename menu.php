        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li <?php echo $display; ?>>
                        <a id="menu-integrantes" href="#" onclick="cargar_contenido(this, 'usuario/vista/tabla_usuario.php', <?php echo $_SESSION['mesa'];?>);" style="background-color: #0c4370;">Integrantes</a>
                    </li>
                    <li <?php echo $display; ?>>
                    ...
                    <!--li <?php #echo $display2; ?>>
                        ...
                        <ul class="nav nav-second-level" style="background:#bfbdbd;">
                            <li>
                                <a href="#" onclick="cargar_contenido(this, 'sistema/vista/tabla_cantidad_mesas.php');">Cantidad de Mesas</a>
                            </li>
                            <li>
                                <a href="#" onclick="cargar_contenido(this, 'sistema/vista/tabla_cantidad_integrantes.php');">Cantidad de Integrantes</a>
                            </li>
                            <li>
                                <a href="#" onclick="cargar_contenido(this, 'sistema/vista/tabla_cantidad_reciclaje.php');">Cantidad de Reciclaje</a>
                            </li>
                        </ul>
                    </li-->
                </ul>
