                    ...
                    <form class="form-row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" id="nombre_mesa" class="form-control" value="<?php echo $nombre_mesa; ?>" placeholder="Nombre de Mesa">
                          </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" id="nombre" class="form-control" value="<?php echo $nombre." ".$apellido; ?>" placeholder="Encargado">
                          </div>
                        </div>                        
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" id="telefono" class="form-control" value="<?php echo $telefono; ?>" placeholder="Telefono">
                          </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" id="correo" class="form-control" value="<?php echo $correo; ?>" placeholder="Correo">
                          </div>
                        </div>   
                        ...
                        <div class="col-md-4 c_toneladas" style="<?php echo $visibilidad_c_toneladas; ?>">
                          <div class="form-group">
                            ...
                            <input type="text" id="capacidad_toneladas" class="form-control tipocaracter" value="<?php echo $capacidad_toneladas; ?>" placeholder="Capacidad en Toneladas">
                          </div>
                        </div>
